...
// #### @config {Object} **Optional** Configuration for the configure method.
//
//
var Router = exports.Router = function (routes, config) {
  this.params   = {};
  this.routes   = {};
    ...
    if (routes.hasOwnProperty(r) && (!this._methods[r] ||
      ...
      if (match[0] && match[0] == path && routes[r][method]) {
        ...
        if (this.recurse && routes === this.routes) {
          ...
          next.after = next.after.concat([router.after].filter(Boolean));
        }
